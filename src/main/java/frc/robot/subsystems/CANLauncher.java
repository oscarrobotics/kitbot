...
public class CANLauncher extends SubsystemBase {
  ...
  public CANLauncher() {
    m_launchWheel = new CANSparkMax(kLauncherID, CANSparkLowLevel.MotorType.kBrushless);
    m_feedWheel = new CANSparkMax(kFeederID, CANSparkLowLevel.MotorType.kBrushless);
